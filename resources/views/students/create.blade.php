...
<form method="POST" action="{{ route('students.store') }}" class="card p-3">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-3">
            ...
            <input type="number" name="year_of_entry" value="{{ old('year_of_entry') }}" class="form-control" required>
        </div>
        <div class="col-md-6">
            <label class="form-label">Nama Orang Tua</label>
            <input type="text" name="parent_name" value="{{ old('parent_name') }}" class="form-control">
        </div>
        <div class="col-md-6">
